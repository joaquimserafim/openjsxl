...
hyperlinks, sheet visibility, defined names, tables, data validations, and conditional formatting
all round-trip. Not carried (yet): in-cell rich text flattens to plain text — see the project
