...
Not carried (yet): defined names / named ranges are read (`Workbook.definedNames`) but dropped on
write, and in-cell rich text flattens to plain text — see the project README's fidelity table.
