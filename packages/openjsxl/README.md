...
and autofilter ranges all round-trip. Not carried (yet): in-cell rich text flattens to plain
text, and an autofilter's per-column criteria/sort are dropped — see the project README's fidelity table.
